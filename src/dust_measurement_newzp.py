...
def main(argv):
    ...
    if ortho:
        ...
        dd_outfile = 'dust_correlation_unsubtracted_dumbdMdP.fits'
        dr_outfile = 'dust_correlation_randoms_dumbdMdP.fits'
    ...
    DK = treecorr.NKCorrelation(min_sep=1,max_sep=200.0,bin_size=.25,sep_units='arcmin')
    DK.process(fgCat,bgCat)
    DK.write(dd_outfile)
    RK = treecorr.NKCorrelation(min_sep=1,max_sep=200.0,bin_size=.25,sep_units='arcmin')
    ...
    fig.savefig('dust_correl_dumbdMdP.png')
