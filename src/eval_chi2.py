...
def main():
    ...
    if (sample=='iifsc'):
        ...
        fr2=fitsio.read(os.path.join(outpath,'dustCorr_fr_orthonorm-v2-galex.fits')) # random fg x background
        dd3=fitsio.read(os.path.join(outpath,'dustCorr_dd_orthonorm-v3-galex.fits')) # The dust signal -- real fg x real background 
        fr3=fitsio.read(os.path.join(outpath,'dustCorr_fr_orthonorm-v3-galex.fits')) # random fg x background
