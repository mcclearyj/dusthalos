...
def get_output_names(basisInd=None,optimal=False):
    if optimal:
        ...
        dd_outfile = '../outputs/dust_correlation2_dd_orthonorm-vdust.fits'
        dr_outfile = '../outputs/dust_correlation2_dr_orthonorm-vdust.fits'
        fr_outfile = '../outputs/dust_correlation2_fr_orthonorm-vdust.fits'
        rr_outfile = '../outputs/dust_correlation2_rr_orthonorm-vdust.fits'
        fig_outfile = '../outputs/correlationFuncFigures/dustCorr2_orthonorm-vdust.png'      
    else:
...
def get_NNoutput_names():
    dd_outfile = '../outputs/dust_correlation_dd_NN2-vdust.fits'
    dr_outfile = '../outputs/dust_correlation_dr_NN2-vdust.fits'
    fr_outfile = '../outputs/dust_correlation_fr_NN2-vdust.fits'
    rr_outfile = '../outputs/dust_correlation_rr_NN2-vdust.fits'           
