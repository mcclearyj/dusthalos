...
do    
    ...
    python $CODEDIR/runner_scripts/make_random_cat_runner.py -c $CONFIGDIR/make_fg_randoms_config_sdss.yaml
    ...
    mv ${CATALOGDIR}/rand_sdss_bg_JOINED_catalog.fits ${CATALOGDIR}/rand_sdss_bg_JOINED_catalog${value}.fits
