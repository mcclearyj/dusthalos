...
def get_output_names(basisInd=None,optimal=False):
    if optimal:
        ...
        dd_outfile = '../outputs/dust_correlation1_dd_orthonorm-vdust.fits'
        dr_outfile = '../outputs/dust_correlation1_dr_orthonorm-vdust.fits'
        fr_outfile = '../outputs/dust_correlation1_fr_orthonorm-vdust.fits'
        rr_outfile = '../outputs/dust_correlation1_rr_orthonorm-vdust.fits'
        fig_outfile = '../outputs/correlationFuncFigures/dustCorr1_orthonorm-vdust.png'      
    else:
...
def get_NNoutput_names():
    dd_outfile = '../outputs/dust_correlation_dd_NN1-vdust.fits'
    dr_outfile = '../outputs/dust_correlation_dr_NN1-vdust.fits'
    fr_outfile = '../outputs/dust_correlation_fr_NN1-vdust.fits'
    rr_outfile = '../outputs/dust_correlation_rr_NN1-vdust.fits'           
