...
def get_output_names(basisInd=None,optimal=False):
    if optimal:
        ...
        dd_outfile = '../outputs/dust_correlation3_dd_orthonorm-vdust.fits'
        dr_outfile = '../outputs/dust_correlation3_dr_orthonorm-vdust.fits'
        fr_outfile = '../outputs/dust_correlation3_fr_orthonorm-vdust.fits'
        rr_outfile = '../outputs/dust_correlation3_rr_orthonorm-vdust.fits'
        fig_outfile = '../outputs/correlationFuncFigures/dustCorr3_orthonorm-vdust.png'      
    else:
...
def get_NNoutput_names():
    dd_outfile = '../outputs/dust_correlation_dd_NN3-vdust.fits'
    dr_outfile = '../outputs/dust_correlation_dr_NN3-vdust.fits'
    fr_outfile = '../outputs/dust_correlation_fr_NN3-vdust.fits'
    rr_outfile = '../outputs/dust_correlation_rr_NN3-vdust.fits'           
