...
hidens = Table.read(
    '/work/mccleary_group/dusty_halos/catalogs/prep_cat_output/redmagic_hidens_y3_GOLD_JOINED_catalog.fits', 
    memmap=True
)

ra_deg = hidens['ra_redmagic_hidens']

dec_deg = hidens['dec_redmagic_hidens']
